...
trait InitialSetup extends Suite with OneServerPerSuite {
  ...
  protected val dbSetup = DBIO.seq(
    ...
    UsersPlacesQuery ++= Seq(
      UsersPlace( 1, 1, UserRole.Admin ), UsersPlace( 1,2, UserRole.Admin ) , UsersPlace(1,3,UserRole.User), UsersPlace(2,1,UserRole.User), UsersPlace(2,2,UserRole.User), UsersPlace(2,5,UserRole.Admin)
    ),
